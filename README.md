...
Run `ng build --prod --base-href https://viska97.github.io/design2019/ --output-path docs` to build the project. The build artifacts will be stored in the `docs/` directory.
